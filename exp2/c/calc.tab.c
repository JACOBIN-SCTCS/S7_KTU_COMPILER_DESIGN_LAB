...
{
  "$end", "error", "$undefined", "'+'", "'-'", "'*'", "'/'", "'%'",
  "NUMBER", "';'", "'('", "')'", "$accept", "start", "expr", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,    43,    45,    42,    47,    37,   258,    59,
      40,    41
};
# endif
...
{
       7,     8,     9,    10,     5,     9,    10,     6,    12,    13,
      14,    15,    16,     7,     8,     9,    10,     0,     0,    11,
       1,     0,     2
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     2,     5,     6,     0,    11,     7,
       8,     9,    10,     3,     4,     5,     6,    -1,    -1,     9,
       8,    -1,    10
};
